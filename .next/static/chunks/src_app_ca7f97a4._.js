(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_ca7f97a4._.js", {
...
_s(ProductsComponent, "/jgZnBTTtRK62YM71fsc0l16+Vg=", false, function() {
    return [
        ...
        "Page.useEffect": ()=>{
            async function fetchPreciosProducto() {
                try {
                    ...
                    const { data: productos, error: errorProductos } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("productos").select("id_producto").eq("nombre_producto", nombreProducto1).limit(1);
...
//# sourceMappingURL=src_app_ca7f97a4._.js.map