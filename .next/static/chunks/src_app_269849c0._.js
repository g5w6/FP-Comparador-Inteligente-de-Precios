(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_269849c0._.js", {
        ...
        "Categorias.useEffect": ()=>{
            async function fetchCategoriesAndProducts() {
                try {
                    ...
                    const { data: categoriesData, error: categoriesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("categorias").select("id_categoria, nombre_categoria");
                    if (categoriesError) throw categoriesError;
                    // Create array to hold our categories with products
                    const categoriesWithProducts = [];
                    // For each category, fetch related products
                    for (const category of categoriesData){
                        const { data: productsData, error: productsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("productos").select("nombre_producto").eq("id_categoria", category.id_categoria);
                        if (productsError) throw productsError;
                        // Add to our categories array
                        categoriesWithProducts.push({
                            id: category.id_categoria,
                            name: category.nombre_categoria,
                            items: productsData.map({
                                "Categorias.useEffect.fetchCategoriesAndProducts": (product)=>product.nombre_producto
                            }["Categorias.useEffect.fetchCategoriesAndProducts"])
                        });
                    }
            ...
            categories.map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        openDropdown === category.name && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: category.items.length > 0 ? category.items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
...
_s(Categorias, "+oOpGl05y7+qgwRCyCPJUlB+nvg=");
_c = Categorias;
...
//# sourceMappingURL=src_app_269849c0._.js.map