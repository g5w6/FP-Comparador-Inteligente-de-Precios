(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_273e2a3f._.js", {
...
"[project]/src/app/components/sliderproducts.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Products = ()=>{
    ...
    const [productsToShow, setProductsToShow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(4);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Products.useEffect": ()=>{
            ...
            return ({
                "Products.useEffect": ()=>window.removeEventListener("resize", handleResize)
            })["Products.useEffect"];
        }
    }["Products.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Products.useEffect": ()=>{
            const fetchProductosAleatorios = {
            ...
            }["Products.useEffect.fetchProductosAleatorios"];
    ...
    const agregarALista = (producto, cantidad)=>{
        console.log("Agregando a la bolsa:", {
            producto,
            cantidad,
            total: producto.precio * cantidad
        });
        alert(`Se agregó ${cantidad} ${cantidad > 1 ? "unidades" : "unidad"} de ${producto.nombre} al carrito de compras`);
...
_s(Products, "Y5orV/F4aylRkTqMurJnWr0yoeU=");
_c = Products;
...
"[project]/src/app/index/bento.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_app_273e2a3f._.js.map