...
const ProductsComponent = ({ precios, nombreProducto })=>{
    ...
    const { addItem, openCart, isOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$index$2f$carrito$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    const [shouldOpenCart, setShouldOpenCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchPreciosProducto() {
            try {
                ...
                const { data: productoData, error: productoError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("productos").select("id_producto").eq("nombre_producto", nombreProducto).single();
                if (productoError) {
                    throw productoError;
                }
                if (!productoData) {
...
//# sourceMappingURL=src_app_productname_page_tsx_811ca081._.js.map